                ...
                >
                    <defs>
                        <linearGradient id="count" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="#FF190D" stopOpacity={0.8} />
                            <stop offset="95%" stopColor="#FF190D" stopOpacity={0} />
                        </linearGradient>
                    </defs>
                    <XAxis dataKey="date" interval={7} tick={<CustomizedAxisTick />} height={90} />
                    <CartesianGrid strokeDasharray="3 3" />
                    <Area type="monotone" dataKey="count" stroke="#FF190D" fillOpacity={1} fill="url(#colorUv)" />
